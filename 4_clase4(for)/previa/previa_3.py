...
#Añadiremos un segundo rectángulo que hará las funciones de suelo
#Añadiremos una aceleración hacia abajo y vamos a hacer que al llegar a la plataforma no se caiga a ningún sitio.
...
SUELO = pygame.Rect(150, 300 , ANCHO,50)
